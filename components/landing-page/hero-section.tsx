  ...
  return (
    <div className="container mx-auto px-8 py-16 text-center flex flex-col items-center bg-custom-bg rounded">
      ...
      <div className="mb-8 space-y-1">
        <p className="font-switzer text-lg leading-5 tracking-tighter text-custom-green/80">You care about our planet but don't know where to start.</p>
        <p className="font-switzer text-lg leading-5 tracking-tighter text-custom-green/80">Let's change that.</p>
      </div>
      <img
